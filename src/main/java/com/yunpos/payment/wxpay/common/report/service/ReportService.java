package com.yunpos.payment.wxpay.common.report.service;
...
public class ReportService {
    ...
    private SysWechatConfigWithBLOBs sysWechatConfig;
    ...
    public ReportService(ReportReqData reportReqData){
        ...
        this.sysWechatConfig = sysWechatConfig;
    }
    
    public ReportService(ReportReqData reportReqData,SysWechatConfigWithBLOBs sysWechatConfig){
        this.reqData = reportReqData;
        this.sysWechatConfig = sysWechatConfig;
    }
     ...
     * @throws Exception
     */
    public static String request(ReportReqData reportReqData,SysWechatConfigWithBLOBs sysWechatConfig) throws Exception {

        //--------------------------------------------------------------------
        //发送HTTPS的Post请求到API地址
        //--------------------------------------------------------------------
        String responseString = new HttpsRequest(sysWechatConfig.getCertLocalPath(), sysWechatConfig.getCertPassword()).sendPost(WechatPayConfig.REPORT_API, reportReqData,sysWechatConfig);
        Util.log("report返回的数据：" + responseString);
