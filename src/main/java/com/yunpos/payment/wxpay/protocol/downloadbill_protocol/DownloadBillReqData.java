package com.yunpos.payment.wxpay.protocol.downloadbill_protocol;
...
public class DownloadBillReqData {
    ...
    REVOKED，已撤销的订单
     */
    public DownloadBillReqData(String deviceInfo,String billDate,String billType,SysWechatConfigWithBLOBs sysWechatConfig){
