...
public class WapPayReqData {
	...
	public WapPayReqData(String outTradeNo,String body, int totalFee,
			String deviceInfo, String spBillCreateIP,String openid, SysWechatConfigWithBLOBs sysWechatConfig) {
		//################必填字段#########################
