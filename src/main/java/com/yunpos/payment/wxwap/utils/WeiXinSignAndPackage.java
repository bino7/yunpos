package com.yunpos.payment.wxwap.utils;
...
public class WeiXinSignAndPackage {
	 ...
	 * @return
	 */
	public static String createPackage(TreeMap<String,String> treeMap,String partnerKey){
	 ...
	 * @return
	 */
	public static String createPaySign(TreeMap<String,String> param,String partnerKey){
	...
	public synchronized static boolean isValidSign(TreeMap<String,String> treeMap){
		...
		String stringSignTemp = string1 + "key="+WechatPayConfig.PATERNER_KEY;
	...
	public static String getPrepayId(TreeMap<String, String> payParamMap,String prepayIdUrl){
		String result=HttpTool.sendPost(prepayIdUrl, payParamMap, "UTF-8");
		return result;
	}
}
