...
public class AlipayController extends BaseController{
	...
	public Object scanCreate(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			AlipayPrecreateReqData alipayPrecreateReqData = new AlipayPrecreateReqData(orderNo, merchant_num.trim(),"扫码预支付", total_fee,extend_params);
	...
	public Object wapCreate(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			AlipayWapPayReqData payReqData = new AlipayWapPayReqData(orderNo, sysAlipayConfig.getPid(), "支付宝手机wap测试", total_fee, sysAlipayConfig.getPid());
			payReqData.setPay_channel(pay_channel);
			payReqData.setTerminal_unique_no(terminal_unique_no);
			payReqData.setMerchant_num(merchant_num);
	...
	public Object query(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			AlipayQueryReqData alipayQueryReqData = new AlipayQueryReqData(trace_num, sysMerchant.getSerialNo());
	...
	public void barNotify(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			SysAlipayConfig sysAlipayConfig= sysAlipayConfigService.findByPid(sysTransaction.getSerialNo());
